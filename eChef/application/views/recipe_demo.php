                ...
                <div class="container background-white">
					...
					<?php
                                        foreach($sastojci as $sastojak){
                                            echo "<li>".$sastojak->naziv." ".$sastojak->kolicina."</li>";
                                        }
					?>
                                    </ul>
                                </div>
                            ...
                            <div class="row animate fadeInUp">
                                ...
                                <p class="text-center margin-bottom-30"><!-- My Skills -->
                                    ...
                                    <div class="progress progress-sm">
                                        <div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width:<?php $suma=0; $brojt=0; foreach($ocene as $ocena){if($ocena->ocena==4){$brojt=$ocena->broj;} $suma+=$ocena->broj; } echo (($brojt/$suma)*100)."%"; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="progress progress-sm">
                                        <div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="78" aria-valuemin="0" aria-valuemax="100" style="width: <?php $suma=0; $brojt=0; foreach($ocene as $ocena){if($ocena->ocena==1){$brojt=$ocena->broj;} $suma+=$ocena->broj; } echo (($brojt/$suma)*100)."%"; ?>">
                                        </div>
                                    </div>
                                    <!-- End My Skills --></p>
